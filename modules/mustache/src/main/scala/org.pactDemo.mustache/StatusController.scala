...
class StatusController(tree: ServiceTree[_, _, ServiceDescription], templateName: String = "status.mustache")(implicit templateMaker: TemplateMaker, displayStatus: Templateable[StatusReport]) extends Controller with PactArrow {
