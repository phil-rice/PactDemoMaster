...
import org.pactDemo.finatra.service.LoggingClient
import org.pactDemo.finatra.structure.{DelegateTree0, RootServiceTree, ServiceDescription, ServiceTree}
import org.pactDemo.finatra.utilities.{FromResponse, NullSl4jLoggingAdapter, SimpleLogMe, ToRequest}
...
trait ServiceLanguageFixture extends MockitoSugar {
  ...
  import org.pactDemo.finatra.structure.ServiceLanguage._
